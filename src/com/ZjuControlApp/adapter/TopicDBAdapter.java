...
public class TopicDBAdapter {
	...
	public void update(long rowid,String title,String body)
	{
		mdb=mdbhelper.getWritableDatabase();
		Calendar calendar=Calendar.getInstance();
		String info=calendar.get(Calendar.YEAR)+"年"+calendar.get(Calendar.MONTH+1)+"月"+calendar.get(Calendar.DAY_OF_MONTH)+"日"+calendar.get(Calendar.HOUR)+"时"+calendar.get(Calendar.MINUTE)+"分";
	...
	public Cursor queryALl()
	{
		...
		Cursor cursor=mdb.query(tableName,new String[]{key_id,key_title,key_body,key_info},null,null,null,null,null);
	    return cursor;
	}
	...
	{
	   mdb=mdbhelper.getReadableDatabase();
	   Cursor cursor=mdb.query(tableName,new String[]{key_id,key_title,key_body,key_info},key_id+"="+rowId,null,null,null,null);
	   return cursor;
	}
