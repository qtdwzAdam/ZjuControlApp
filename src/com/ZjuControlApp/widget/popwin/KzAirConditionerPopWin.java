...
public class KzAirConditionerPopWin extends PopupWindow {

	private View mMenuView;
	Button linear_setting,linear_tuichu;

	public KzAirConditionerPopWin(final Activity context,OnClickListener itemsOnClick) {
		super(context);
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.hif_kz_airconditioner, null);

		int h = context.getWindowManager().getDefaultDisplay().getHeight();
		int w = context.getWindowManager().getDefaultDisplay().getWidth();

		//设置按钮
		linear_setting = (Button) mMenuView.findViewById(R.id.HIF_KZ_kongtiao_set_btn);
		...
		//取消按钮
		linear_tuichu = (Button) mMenuView.findViewById(R.id.HIF_KZ_kongtiao_cancel_btn);
		...
		mMenuView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				int height = mMenuView.findViewById(R.id.hif_kz_airconditioner_set_main).getTop();
