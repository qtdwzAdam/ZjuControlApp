...
import com.ZjuControlApp.activity.AddKzKaiGActivity;
 ...
 * 
 */
public class ThreeFragmentKzKaig extends Fragment implements OnClickListener,
		SwipeRefreshLayout.OnRefreshListener {
	public static final String tag = "ThreeFragmentKzKaig";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_three_kz_kaig, container,
				false);
		linear_jiaru = (LinearLayout) view.findViewById(R.id.kz_kaig_add_new);
		mainLayout = (LinearLayout) view.findViewById(R.id.kz_kaig_main);
		...
		mSwipeLayout = (SwipeRefreshLayout) view
				.findViewById(R.id.kz_kaig_main_refresh);
		...
		// for listview
		lv = (ListView) view.findViewById(R.id.kz_kaig_listView);
	...
	public void onClick(View v) {
		...
		case R.id.kz_kaig_add_new:
			intent = new Intent(getActivity(), AddKzKaiGActivity.class);
	...
	private class MyListener implements OnClickListener {
		int mPosition;
		private KzKaiGPopWin menuWinKaiG;
		private OnClickListener itemsOnClickKaiG = new OnClickListener() {
			public void onClick(View v) {
				menuWinKaiG.dismiss();
			}
		};
		...
		public void onClick(View v) {
			...
			// lvAdapter.notifyDataSetChanged();
			menuWinKaiG = new KzKaiGPopWin(getActivity(), itemsOnClickKaiG, mPosition);
			menuWinKaiG.showAtLocation(
					getActivity().findViewById(R.id.kz_kaig_add_new),
	 ...
	 * 
	 */
	private class KzKaiGPopWin extends PopupWindow {
		private View mMenuView;
		Button linear_setting, linear_tuichu;

		public KzKaiGPopWin(final Activity context, OnClickListener itemsOnClick,
				int winPosition) {
			super(context);
