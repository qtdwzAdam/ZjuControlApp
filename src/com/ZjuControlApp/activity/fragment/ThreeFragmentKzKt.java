 ...
 * 
 */
public class ThreeFragmentKzKt extends Fragment implements OnClickListener,
		SwipeRefreshLayout.OnRefreshListener {
	public static final String tag = "ThreeFragmentKzKt";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mSwipeLayout = (SwipeRefreshLayout) view
				.findViewById(R.id.kz_kt_main_refresh);
	...
	private class MyListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			menuWinKT.showAtLocation(
					getActivity().findViewById(R.id.kz_kt_add_new),
	...
	private class KzKtPopWin extends PopupWindow {
		...
		public KzKtPopWin(final Activity context, OnClickListener itemsOnClick,
				int winPosition) {
			super(context);
