...
public class ThreeFragmentKzKt extends Fragment implements OnClickListener, SwipeRefreshLayout.OnRefreshListener{
	private static final String tag="ThreeFragmentKzkongtiao";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_three_kz_kt, container,
				false);
		linear_jiaru = (LinearLayout) view.findViewById(R.id.kz_kt_add_new);
		mainLayout = (LinearLayout) view.findViewById(R.id.kz_kt_main);
		
		linear_jiaru.setOnClickListener(this);
		mainLayout.setOnClickListener(this);
		
		// for pull to refresh
		mSwipeLayout = (SwipeRefreshLayout) view.findViewById(R.id.kz_kt_main_refresh);
		...
		// for listview 
		lv = (ListView) view.findViewById(R.id.kz_kt_listView);		
		mdbhelper=new TopicDBAdapter(getActivity(), "KzKt");
		mdbhelper.open();
		getData();
	...
	public void onClick(View v) {
		...
		case R.id.kz_kt_add_new:
			intent = new Intent(getActivity(),AddKzKtActivity.class);
	...
	private class MyListener implements OnClickListener{
        ...
        public void onClick(View v) {  
            // TODO Auto-generated method stub  
        	menuWinKT = new KzKtPopWin(getActivity(), itemsOnClickKT, mPosition);
        	menuWinKT.showAtLocation(getActivity().findViewById(R.id.kz_kt_add_new),
	...
	private class KzKtPopWin extends PopupWindow {
		private View mMenuView;
		Button linear_setting,linear_tuichu;

		public KzKtPopWin(final Activity context,
