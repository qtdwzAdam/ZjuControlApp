package com.ZjuControlApp.mipush;
...
import com.ZjuControlApp.mipush.MipushMessageReceiver.DemoHandler;
...
public class MipushApplication extends Application {
	...
	public static final String APP_ID = "2882303761517229446";
	// user your appid the key.
	public static final String APP_KEY = "5481722983446";

	// 此TAG在adb logcat中检索自己所需要的信息， 只需在命令行终端输入 adb logcat | grep
	// com.xiaomi.mipushdemo
	public static final String TAG = "herotculb123";
